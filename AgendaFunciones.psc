...
Funcion nombre <- SepararNombre(dato)
...
Funcion telef <- SepararTelefono(nombre, telef, dato, i, j)
			...
			3:
				...
				Para i=0 Hasta ne-1 Con Paso 1 Hacer
					...
					Para j=0 Hasta Longitud(dato[i]) Con Paso 1 Hacer
						...
						nombre = SepararNombre(nombre, telef, dato, i, j);
						telef = SepararTelefono(nombre, telef, dato, i, j);
